...
For each short strike: realistic probability of being tested before expiry. Use delta, distance vs expected move, macro/news catalysts. Bull case and bear case for each side.

**6. RISK FLAGS**
3–5 specific risks. For each: what happens, at what price, what action to take (close/roll/hedge). Do not leave any numbered item blank.

**7. FINAL RECOMMENDATION**
One paragraph. Full trade: legs, strikes, expiry, minimum credit to accept. Exit plan: profit target and stop-loss price. If risk/reward is POOR, state whether to pass or adjust.`;
}
...
function renderAnalysis(text) {
  ...
  // During streaming, show raw preview until section 1 arrives
  const hasFirstSection = text.includes('**1. GO / NO-GO**') || text.includes('1. GO / NO-GO');
  if (!hasFirstSection) {
